...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('payment_transactions', function (Blueprint $table) {
            ...
            // Hangi işlem için? (Polymorphic olabilir veya nullable FK)
            // Dokümanda ayrı ayrı belirtilmiş ama biz nullable FK kullanalım, sorgulaması daha kolay.
            ...
            $table->string('transaction_id')->nullable()->index(); // İyzico'nun verdiği ID (paymentId)
        ...
        // 2. WEBHOOK LOGS (Gelen İsteklerin Logu)
        Schema::create('webhook_logs', function (Blueprint $table) {
            ...
            $table->string('payload_hash', 32); // MD5 (Aynı webhook tekrar gelirse işleme)
        ...
        // 3. Önceki tablolara transaction_id ekleyelim (İlişki için)
        Schema::table('orders', function (Blueprint $table) {
            $table->foreignId('payment_transaction_id')->nullable()->after('status')->constrained('payment_transactions');
        });
