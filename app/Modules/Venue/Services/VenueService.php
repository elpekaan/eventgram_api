...
class VenueService
{
    ...
    public function updateStatus(Venue $venue, VenueStatus $status): Venue
    {
        // Burada ileride "Email Gönder" gibi yan etkiler (Side Effects) olacak.
        // O yüzden bunu controller'da değil, serviste yapıyoruz.
