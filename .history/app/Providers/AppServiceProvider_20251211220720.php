...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        // Ticket Service Binding - DÜZELTİLDİ!
        $this->app->bind(
            \App\Contracts\Services\TicketServiceInterface::class,
            \App\Modules\Ticket\Services\TicketService::class
        );
    }
...
// TicketTransfer Service Binding
$this->app->bind(
    \App\Contracts\Services\TicketTransferServiceInterface::class,
    \App\Modules\Transfer\Services\TicketTransferService::class
);
